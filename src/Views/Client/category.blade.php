    ...
    <div class="grid grid-cols-12 gap-4 p-4">
        <aside class="col-span-3 shadow-md bg-gray-50 h-fit">
            ...
            <ul class="flex flex-col">
                ...
                @endforeach
                <a href="{{ url('shop') }}" class="font-medium text-center hover:text-amber-500 bg-gray-100 p-3 pl-8">View All</a>
            </ul>
        </aside>

        <main class="col-span-9">
            @if (!empty($title['name']))
                <h2 class="font-semibold text-3xl pb-8 text-center text-amber-500">
                    {{ $title['name'] }}
                </h2>
            ...
            <div class="flex items-center justify-center space-x-2 font-medium my-8">
                <!-- Previous Page Link -->
